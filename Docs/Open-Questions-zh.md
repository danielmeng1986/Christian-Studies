...
“建议起点”只是为了让讨论有一个具体方案，并不授权实施。只有正式决议得到接受，而且受影响的中英文文档都已同步更新，问题才算关闭。

## 决策优先级

| ID | 决策 | 必须完成的阶段 | 状态 |
| --- | --- | --- | --- |
| OQ-001 | 产品边界 | 结构性重构前 | 未决 |
| OQ-002 | 运行与部署形态 | 应用外壳前 | 未决 |
| OQ-003 | 持久存储与 Git | 结构性重构前 | 未决 |
| OQ-004 | 规范化内容的权威表示 | 结构性重构前 | 未决 |
| OQ-005 | 平台与书籍包边界 | 结构性重构前 | 未决 |
| OQ-006 | 数据库角色 | 结构性重构前 | 未决 |
| OQ-007 | 导入格式与审核边界 | 导入流水线前 | 未决 |
| OQ-008 | 注释锚点身份 | 共享阅读器/数据模型前 | 未决 |
| OQ-009 | Context Service 契约 | Context 通用化前 | 未决 |
| OQ-010 | 模型路由策略 | 多模型前 | 未决 |
| OQ-011 | MCP 与技能信任模型 | 第一项外部能力前 | 未决 |
| OQ-012 | 隐私与提供商资格 | 多提供商/工具前 | 未决 |
| OQ-013 | 结构化笔记工作流 | 知识功能前 | 未决 |
| OQ-014 | 跨书知识身份 | 知识功能前 | 未决 |
| OQ-015 | 来源权利与仓库可见性 | 扩大导入/分享前 | 未决 |
