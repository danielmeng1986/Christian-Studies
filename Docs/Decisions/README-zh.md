...
| ADR | 决议 | 状态 | 相关问题 |
| --- | --- | --- | --- |
| [ADR-0001 中文](ADR-0001-Product-Deployment-and-Distribution-zh.md) / [English](ADR-0001-Product-Deployment-and-Distribution.md) | 产品边界、桌面方向与分发阶段 | 已接受 | OQ-001–OQ-003 |
