...
当前阅读版会确定性构建全部 20 章，并包含章节导航、三栏阅读布局、窄屏侧栏、三种阅读主题、脚注与经文交互、逐章笔记，以及“与 AI 讨论”第一版。
...
发送前会先显示本轮上下文预览：与选区相同或重叠的个人笔记默认纳入，可逐条排除；同段但不重叠的笔记只显示为候选。命中的中英文译名也会显示，精确命中可排除，歧义候选需明确勾选才会发送。这些选择只影响当前一轮，不会修改或删除原笔记。
